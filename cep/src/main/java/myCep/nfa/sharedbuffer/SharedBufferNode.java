...
package myCep.nfa.sharedbuffer;

import myCep.nfa.sharedbuffer.SharedBufferEdge.SharedBufferEdgeSerializer;
...
public class SharedBufferNode {
     ...
     *     myCep.nfa.sharedbuffer.SharedBufferNodeSerializer} instead.
     */
    @Deprecated
