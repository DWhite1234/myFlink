...
import myCep.nfa.sharedbuffer.EventId;
import myCep.nfa.sharedbuffer.NodeId;
import myCep.nfa.sharedbuffer.SharedBuffer;
import myCep.nfa.sharedbuffer.SharedBufferAccessor;
import myCep.operator.CepOperator;
import myCep.pattern.Pattern;
import myCep.pattern.conditions.IterativeCondition;
import myCep.time.TimerService;
...
import static myCep.nfa.MigrationUtils.deserializeComputationStates;
...
public class NFA<T> {
    ...
    public static class MigratedNFA<T> {
        ...
        private final myCep.nfa.SharedBuffer<T> sharedBuffer;

        public myCep.nfa.SharedBuffer<T> getSharedBuffer() {
            return sharedBuffer;
        }
        ...
        MigratedNFA(
                ...
                final myCep.nfa.SharedBuffer<T> sharedBuffer) {
    ...
    public static final class NFASerializerConfigSnapshot<T>
        ...
        public NFASerializerConfigSnapshot(
                ...
                TypeSerializer<myCep.nfa.SharedBuffer<T>> sharedBufferSerializer) {
    ...
    public static final class MigratedNFASerializerSnapshot<T>
        ...
        protected NFASerializer<T> createOuterSerializerWithNestedSerializers(
            ...
            @SuppressWarnings("unchecked")
            TypeSerializer<myCep.nfa.SharedBuffer<T>> sharedBufferSerializer =
                    (TypeSerializer<myCep.nfa.SharedBuffer<T>>) nestedSerializers[1];
    ...
    public static class NFASerializer<T> extends TypeSerializer<MigratedNFA<T>> {
        ...
        private final TypeSerializer<myCep.nfa.SharedBuffer<T>>
        ...
        public NFASerializer(TypeSerializer<T> typeSerializer) {
            this(
                    typeSerializer,
                    new myCep.nfa.SharedBuffer.SharedBufferSerializer<>(
        ...
        public MigratedNFA<T> deserialize(DataInputView source) throws IOException {
            ...
            myCep.nfa.SharedBuffer<T> sharedBuffer =
